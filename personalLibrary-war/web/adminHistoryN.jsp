...
<html>
    ...
    <body background="bg.jpg">
        <form method="post" action="adminHistory.do">
             <h1>Books</h1>
 ...
 <% 
    // out.print( String.format("Subject--"));
              DataAccess db = new DataAccess();
               String un = (String) session.getAttribute("sname");
         ArrayList<bookList> lst = (ArrayList<bookList>)db.getBookListN(un);
 ...
 <br/> <br/> <br/>
            <input type="radio" name="ed" value="edit" /> Edit <br/>
            <input type="radio" name="ed" value="del" /> Delete <br/><br/>
